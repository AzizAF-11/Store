<div x-data="{ open: false }" x-show="open" @open-register-modal.window="open = true"
    @close-register-modal.window="open = false" x-transition style="display: none;">
        ...
        <div class="bg-white rounded-lg overflow-hidden w-full max-w-5xl max-h-full flex shadow-lg relative z-10">
            ...
            <div class="w-1/2 hidden md:block">
                <img src="{{ asset('images/img1.jpg') }}" alt="Login Image"
                    class="object-cover w-full h-full max-w-none">
            </div>
            ...
            <div class="w-full md:w-1/2 p-8 relative font-ibm">
                ...
                <p class="text-sm text-center text-gray-500 mt-6">
                    Already have an account? <a href="#" class="text-pink-500 hover:underline">Log in</a>
                </p>
